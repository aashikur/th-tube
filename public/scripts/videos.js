...
// Dynamically generate video content
    ...
    div.innerHTML = `
      <div>
        ...
        <div class="mt-2 flex gap-2">
          ...
          <div class="px-1">
            <h1 class="font-bold mb-2 text-sm md:text-[1.125rem]">Building a Winning UX Stategy using the Kano Model</h1>
